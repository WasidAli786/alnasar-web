...
const MembershipBenefits = () => {
  return (
    <>
      <div className="custom-container mr-0 px-0 flex flex-col gap-4 lg:flex-row justify-between lg:items-center pb-10 lg:py-10">
        <div className="lg:max-w-[300px]">
          <h2 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-custom-primary">
            ENJOY AMAZING BENEFITS SUCH AS...
          </h2>
        </div>

        <div className="transform -skew-x-6 border-t-[30px] border-custom-primary border-l-[15px]">
