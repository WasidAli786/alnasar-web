  ...
  return (
    <>
      <Tabs
        ...
        classNames={{
          tabList:
            "gap-0 w-full relative rounded-none p-0 bg-custom-secondary-200 text-white divide-x divide-gray-600",
          tab: "rounded-none data-[selected=true]:bg-custom-primary h-12",
          tabContent:
            "text-xs lg:text-lg text-white font-bold group-data-[selected=true]:text-black",
          panel: "p-0",
        }}
      >
        {(item) => (
          <Tab key={item.id} title={item.title}>
            ...
            <div className="grid grid-cols-12 custom-container py-10 relative">
              <div className="col-span-full md:col-span-9 space-y-8">
                ...
                <div className="rounded-[10px] py-5 px-3 border-2 border-gray-400 bg-[#1A377599] z-50">
                  ...
                  <h3 className="text-[#D9D9D9] font-semibold mt-1">
                    Key Benefits
                  </h3>

                  <BenefitsSlider benefits={item.keyBenefits} />

                  <h3 className="text-[#D9D9D9] font-semibold mt-6">
                    Additional Perks
                  </h3>
                  <div className="mt-3 space-y-4 max-h-[280px] overflow-y-auto">
                    {item.perks.map((perk, index) => (
                      ...
                      >
                        ...
                        <h2 className="text-white font-normal">{perk.title}</h2>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <div className="md:col-span-3 absolute -top-10 md:-top-0 -right-24 md:-right-0 md:relative -z-10">
                <div className="relative h-[400px] md:h-[600px] w-[450px]">
                  <NextImage
